...
public class CommonControllerTest {
    ...
    public void uploadImgTest() throws Exception {
        ...
        MockMultipartFile upload= new MockMultipartFile("image","1.jpg","multipart/form-data",fis);

        MockHttpServletRequestBuilder request =
                MockMvcRequestBuilders.fileUpload("/common/img/upload")
                        .file(upload)
                        ...
                        .param("app_key", Constants.APP_KEY).param("sign", SignUtils.generateSign(paramMap, Constants.APP_KEY, Constants.APP_SECRET));
